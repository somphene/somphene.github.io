...
### Poster 
* Different parts of this work were presented at Enthuse, Tech and Research & Development exposition, ResearchX, IIT Bombay to Professors, esteemed guests, Alumni, experts from industry and students. The [Poster](https://drive.google.com/file/d/1kz88fNsu9a-dw6SsTkoKsX1vWJh6yJw6/view?usp=sharing) is not visible for mundane reasons.
...
Maxwell's Equations are linear [Partial Differential Equation (PDEs)](https://somphene.github.io/notes/). However, they are very nonlinear with respect to geometric settings. This imposes limitations on the proposed invisibility cloaking (Pendry, 2006) with scaling. 
