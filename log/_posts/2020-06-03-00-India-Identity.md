...
blog-category: blog
published: true
title: Identify that India Identifies
author: Som Phene 
...
Since childhood I used to feel like there is no one to look up to in the field of fundamental Natural Sciences. All the famous, Bigshots and Prize winners to whom people looked up to seemed to be foreigners. However, to my surprise, after having studied some parts of Fundamental Science, I have come to identify that India has always produced people who gave Fundamental Identities to the Universe.
  ...
  - [Brahmagupta](https://en.wikipedia.org/wiki/Brahmagupta) gave the symbol $$0$$ to denote zero. This is ultimate cryptography. One symbol to denote the entire Universe as his Name suggests and he used a cycle (circle) to be that symbol. Further, the way in which he wrote is also very fundamental. Using elliptic Sanskrit, words such as "rupa" meaning forms and colors to Identify Mathematics and Astronomy with Nature.
  
  - [Satyendra Nath Bose](https://en.wikipedia.org/wiki/Satyendra_Nath_Bose) provided 'Boson' as the Identity to particle form of Light. It makes Boson the fundamental Identity of particles.
...
Apart from Natural Sciences, we have seen plenty of Identities such as
  ...
  - [Jiddu Krishnamurthi](https://en.wikipedia.org/wiki/Jiddu_Krishnamurti) gave "Observer is Observed" as the cyclic Identity to unify what is experienced and the experiencer. This lights the complete experience to be one which cannot be captured by an observer. It is the meeting of observer and the object where the cycle completes. 
  ...
  - CEO's of major Companies like Satya Nadella (Microsoft) and Sundar Pichai (Google) provide themselves as the Identity for the work of their company.
