...
layout: post
blog-category: blog
title: Computational Materials Science Departments Review
author: Som Phene
image: 
...
* [Prof. Devereaux](https://profiles.stanford.edu/thomas-devereaux)'s DFT, ED and DMRG based simulations for spectroscopy. This matched the background I acquired in the Computational Many Body Physics course. Their group collaborates and makes heavy use of the experimental resources at Stanford.

* [Prof. Brongersma](https://mse.stanford.edu/people/mark-brongersma)'s work on plasmonics and metasurfaces is highly aligned with my interests. The experimental group of [Prof. Jennifer Dionne](https://mse.stanford.edu/people/jennifer-dionne) is perfect to complement the theoretical studies.

* [Prof. Shanhui Fan](https://web.stanford.edu/~shanhui/)'s group in EE working on nanophotonics is also a great support for theoretical stuides and simulation.
