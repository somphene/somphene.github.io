...
## Enumerative Geometry 08 Gromov Witten 
...
- Circle $$a \cdot x \cdot x + a \cdot y \cdot y + b \cdot z \cdot z +  c \cot x \cdot z +  d \cdot y \cdot z =0$$ Moduli Space $$[a:b:c:d] \in \mathbb{P}^3$$. Tangency condition resultant. 
  - [Pencil interpolating circle Desmos Calculator](https://www.desmos.com/calculator/yggneslgk9)
-  Moduli Space
...
- Compactify Moduli Space
  ...
  - Be careful to choose right compactification.
