...
This course on Optimization, SC 607 IITB (2020) is being recorded for [CDEEP](http://www.cdeep.iitb.ac.in/vod/vodCloud/course_intra.php?ccode=320) which places a lot constraints on the interaction. Find the notes for lecture 1 in the link below. He gave an introduction to optimization and provided motivation to build formal techniques to solve optimization problems. The class ended with some review of Real Analysis.
