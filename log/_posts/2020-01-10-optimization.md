...
* The notion of a sequence $$ (x_n)_{n \in \mathbb{N}}$$ converging can be formalized as a challenge problem: A sequence converges to a point $$x^*$$ means that for any given $$\epsilon >0$$, there is a point in the sequence after which all points are within $$\epsilon >0$$ distance of $$x^*$$. That is
